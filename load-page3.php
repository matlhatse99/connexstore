...
if (isset($_POST['email'])) {
	...
	check_if_exists_same_page($conn,$dbname,'post4','email',$email," account with $email has already been created <a  href='signup-load-page.php' button type='button' class='btn btn-primary'>Back</button></a>");
	check_if_exists_same_page($conn,$dbname,'post4','id',$id," account with $id has already been created");

    insert_info($conn,$dbname,'post4',"email",$email);
    update_info($conn,$dbname,'post4',"password","email",$password,$email);
    ...
    echo("$email");
    echo("<br>");
    echo("<p style='font-size: 20px; text-align: center;'>Welcome Admin<p>");
    echo("<br>");
    echo("");
...
<div class="bless2">
              <i class="fa fa-dashboard" style="font-size:48px;color:red;"></i>
              <br>
              <a  href="admin.php" button1 type="button" class="btn btn-primary" style="">Dashboard</button1></a>
          </div>
<div class="bless1">         
     <i class="fa fa-shopping-basket" style="font-size:48px;color:red;"></i>    
    <a  href="load-page2.php" button type="button" class="btn btn-primary" style="left: 60%; top: 10%">SHOP</button></a>
</div>  
