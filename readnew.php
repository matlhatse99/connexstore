...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
 ...
 <div class="container">
   ...
   <div class="row">
    <div class="col-md-12">
      <h1 class="mt-5 mb-3"  style="width: 40%;margin-left: 400px;">View Record</h1>
      <div class="form-group1">
<label style="width: 40%;margin-left: 400px;">Image</label>
    <p style="width: 40%;margin-left: 400px;"><b><?php echo "<td style='width: 600px'> <img style='150%;' src='images/$image'</td>"; ?></b></p>
 </div>    
  <div class="form-group1">
...
<label style="width: 40%;margin-left: 400px;">Decription</label>
<p style="width: 40%;margin-left: 400px;"><b><?php echo $row["description"]; ?></b></p>
</div>
<div class="form-group1">
<label style="width: 40%;margin-left: 400px;">Stock</label>
<p style="width: 40%;margin-left: 400px;"><b><?php echo $row["stock"]; ?></b></p>
</div>
<div class="form-group1">
<label style="width: 40%;margin-left: 400px;">Status</label>
<p style="width: 40%;margin-left: 400px;"><b><?php echo $row["status"]; ?></b></p>
</div>
<div class="form-group1">
<label style="width: 40%;margin-left: 400px;">Price</label>
<p style="width: 40%;margin-left: 400px;"><b><?php echo $row["price"]; ?></b></p>
</div>
<p style="width: 40%;margin-left: 400px;"><a href="inde.php" class="btn btn-primary">Back</a></p>
</div>
</div>
</div>
</div>
