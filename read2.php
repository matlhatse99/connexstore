...
<body id="index" class="lang-en country-za currency-zar layout-left-column page-index tax-display-enabled live_edit_0  1.7.8.8 ps_178
    ...
    <main>
		...
		<div class="blockcart cart-preview inactive" data-refresh-url="//connexstore.co.za/module/ps_shoppingcart/ajax">
            ...
            <div class="menu js-top-menu position-static hidden-sm-down" id="_desktop_top_menu">
                ...
                <li class="home_icon"><a href="load-page2.php"><i class="icon-home"></i><span>Home</span></a></li>
                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="admin.php" data-depth="0">
                            Products Record
                        </a>
                    </li>

                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="users.php" data-depth="0">
                            Users
                        </a>
                    </li>

                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="customer.php" data-depth="0">
                            custoners
                        </a>
                    </li>

                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="useradmin.php" data-depth="0">
                            ADMIN
                        </a>
                    </li>
   ...
   <div class="row">
    <div class="col-md-12">
      <h1 class="mt-5 mb-3">Users Record</h1>
