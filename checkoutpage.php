...
<head>
    ...
    <link rel="stylesheet" href="load-page2.php" type="text/css">
...
include_once("functions-page.php");
    ...
    foreach ($_SESSION as $key=>$val){
        if ($key == "user_id" || $key == "Admin_name"){continue;}
    echo("<br>");
    echo("<br>");
    ...
    echo("
    <form class='sello' action='' method='post'>
    <img src='images/$image' style='width:100px;'>
    $name [Each item] R$price 
        <input type='number' min='1' name='product' value= '$quantity' style='text-align: center;'>
        <button class='btn add-to-cart' name='quan' type='submit'>
    ...
    echo("
    <form class='sello2' action='load-page.php' method='post'>
    ...
    echo("Total price R$total");
   
 ?>    
 <a  href="payment.php" button type="button" class="btn btn-primary" style="width: 10%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;">Make Payment</button></a>
