            ...
            <div class="header-top">
                <div class="container">
                    <div class="row">
                        ...
                        <a  href="update_profile.php" button type="button" class="btn btn-primary" style="width: 10%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;"><i class="fa fa-user-circle-o" style="font-size:36px"></i>Profile</button></a>
                        <!-- /Block search module TOP -->
    ...
    foreach ($_SESSION as $key=>$val) {$total++;} echo $total;?>
            ...
            <div class="menu js-top-menu position-static hidden-sm-down" id="_desktop_top_menu">
                <ul class="top-menu container" id="top-menu" data-depth="0">
                    <li class="home_icon"><a href="logout.php"><i class="icon-home"></i><span>Home</span></a></li>
