 ...
 <div class="container">
    ...
    <div class="content">
        ...
        <div class="wrapper">
            ...
            <a href="createnew.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New product</a>
            ...
            echo "<tr>";
            echo "<td>" . $row['id'] . "</td>";
            echo "<td style='width: 600px'> <img style='150%;' src='images/$image'</td>";
            echo "<td>" . $row['name'] ."</td>";
            ...
            echo "<td>";
            echo '<a href="readnew.php?id='.$row['id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
            
            echo '<a href="updatenew.php?id='.$row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
            
            echo '<a href="deletenew.php?id='.$row['id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
            echo "</td>";
            echo "</tr>";
            }
            echo "</tbody>";
